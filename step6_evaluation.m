...
root_folder_dicom = 'G:\Cardiac Segmentation\MICCAI09\Sunnybrook Cardiac MR Database DICOMPart1\Sunnybrook Cardiac MR Database DICOMPart1\OnlineDataDICOM';
root_folder_manual = 'G:\Cardiac Segmentation\MICCAI09\Sunnybrook Cardiac MR Database ContoursPart1\Sunnybrook Cardiac MR Database ContoursPart1\OnlineDataContours';
root_folder_auto = 'G:\Cardiac Segmentation\MarkGuided_Levelset_Cardiac_Segmentation\output\Sunnybrook Cardiac MR Database DICOMPart1\Sunnybrook Cardiac MR Database DICOMPart1\OnlineDataDICOM';



results_folder = root_folder_auto;
dirs = dir([root_folder_dicom filesep folder_prefix]);
...
for i = 1:num_studies
    ...
    dicom_folder = [root_folder_dicom filesep dirs(i).name filesep para.dicom_foldername];
...
%     manual_contour_folder = [root_folder filesep 'OnlineDataContours' filesep dirs(i).name filesep para.manual_contour_foldername filesep para.manual_contour_subfoldername];
    manual_contour_folder = [root_folder_manual filesep dirs(i).name filesep para.manual_contour_foldername filesep para.manual_contour_subfoldername];
    ...
    %was used.
%     auto_contour_folder = [root_folder filesep 'OnlineDataContours' filesep dirs(i).name];
        auto_contour_folder = [root_folder_auto filesep dirs(i).name];
